...
def click():
    ...
    move_num.delete(0.0,END)
    global x
    x,y = subprocess.Popen(["/home/siddhi/Documents/4-2/AI/Assignment_1/AI_Q2.exe "+s_red+" "+s_blue+" "+s_green] , stdout = subprocess.PIPE, stderr = subprocess.PIPE, shell=True).communicate()
    x = x.decode()
    x = x.split('\n')
    global ind
    ind = 0
